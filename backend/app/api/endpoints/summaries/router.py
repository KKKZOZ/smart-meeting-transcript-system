...
def get_meeting_data(db: Session = Depends(get_db)):
    ...
    return {"title": title_list, "content": content_list, "timestamp": timestamp_list,"meeting_id": meetingid_list}
...
def search_query(s_query ,db: Session = Depends(get_db)):
    ...
    return {"title": new_title_list, "content": new_content_list, "timestamp": new_timestamp_list,"meeting_id": new_meetingid_list}
