...
INSERT INTO notifications (notification_id, user_id, meeting_id, content, ddl, status)
VALUES (UUID(), '1', 'f885f4e5-b450-477d-8efa-436ac4b41c0c', '用户1的会议1的通知', CURRENT_TIMESTAMP, 'unread');
