...
<template>
  <div class="collapse navbar-collapse w-auto h-auto h-100" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <sidenav-item to="/new-page" :class="getRoute() === 'new-page' ? 'active' : ''"
      ...
      <li class="nav-item">
        <sidenav-item to="/create-trans" :class="getRoute() === 'create-trans' ? 'active' : ''"
      ...
      <li class="nav-item">
        <sidenav-item to="/tasks" :class="getRoute() === 'tasks' ? 'active' : ''"
