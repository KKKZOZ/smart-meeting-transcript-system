                            ...
                            <table class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-secondary text-md font-weight-bolder opacity-7">会议内容(前100字)</th>
                                        <th class="text-secondary text-md font-weight-bolder opacity-7">开始时间</th>
                                        <th class="text-center text-secondary text-md font-weight-bolder opacity-7">
                                            会议创建者</th>
                                        <th class="text-center text-secondary text-md font-weight-bolder opacity-7">操作
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr v-for="meeting in filteredMeetings" :key="meeting.meeting_id">
                                        <td>
                                        ...
                                        <td>
                                            <div
                                                style="max-height: 10vh; overflow-y: auto; word-wrap: break-word; white-space: normal;">
                                                <p class="text-md font-weight-bold mb-0">{{ meeting.content }}</p>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td class="align-middle text-center">
                                            <div class="d-flex justify-content-center gap-3">
                                                <argon-button color="success" size="sm"
                                                    @click="handleExtract(meeting.meeting_id)" class="mb-0 text-md">
