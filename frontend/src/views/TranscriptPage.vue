  ...
  <div class="app-container">
      ...
      >
        ...
        <template #tip>
          <div class="el-upload__tip">
            Upload audio files (MP3 or WAV, under 50MB)
          </div>
        </template>
      </el-upload>
      <!-- 上传按钮 -->
    ...
    >
      ...
      <div class="action-buttons">
        <el-button v-if="isTranscribed === 2" type="primary" @click="generateSummary">Summary</el-button>
        <el-button v-if="isTranscribed === 2" type="primary" @click="generateTasks">Tasks</el-button>
      </div>
    </div>
  </div>
</template>
